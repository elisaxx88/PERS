...
Public Class CLEHHDORO
  Inherits CLE__BASE
  Public oCldhh As CLDHHDORO
  ...
  Public Overrides Function Init(ByRef App As CLE__APP,
    ...
    If MyBase.strNomeDal = "BD__BASE" Then MyBase.strNomeDal = "BDHHDORO"

    MyBase.Init(App, oScriptEngine, oCleLbmenu, strTabella, False, "", "")
    oCldhh = CType(MyBase.ocldBase, CLDHHDORO)
    oCldhh.Init(oApp)



    If CLN__STD.NTSIstanziaDll(oApp.ServerDir, oApp.NetDir, "BEHHDORO", "BEHHDORO", oTmp, strErr, False, "", "") = False Then
