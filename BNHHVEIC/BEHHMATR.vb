...
Public Class CLEHHMATR
  ...
  Public Overrides Function Init(ByRef App As CLE__APP,
    ...
    With dsShared.Tables("XXX")
      '.Columns.Add("",GetType())
      .Columns.Add("rl_matric", GetType(String))
      .Columns.Add("rl_dtrilascio", GetType(String))
      .Columns.Add("rl_note", GetType(String))
      .Columns.Add("rl_tipomatr", GetType(String))
      .Columns.Add("rl_dtscadgarven", GetType(String))
      .Columns.Add("rl_dtscadgaracq", GetType(String))
  ...
  Public Sub SalvaGriglia()
    oCldhh.ScriviTabellaSemplice(strDittaCorrente, "NNMATRICS", dsShared.Tables("NNMATRICS"), "", "", "")
  End Sub
  ...
  Public Sub CPNECaricaDTMatricole(intCodCli As Integer, strcodart As String)
    oCldhh.CPNEPulisciDs(dsShared, "NNMATRICS")
    oCldhh.CPNECaricaDTMatricole(dsShared, intCodCli, strcodart)
  End Sub

  Public Sub CPNECaricaDTMatricoleconfiltri(intCodconto As Integer, strmatricola As String)
    oCldhh.CPNEPulisciDs(dsShared, "NNMATRICS")
    oCldhh.CPNECaricaDTMatricoleconfiltri(dsShared, intCodconto, strmatricola)
  End Sub
